...
const t2_colorPrimary = Color.fromARGB(255, 101, 45, 143);
const t2_colorPrimaryDark = Color.fromARGB(255, 101, 45, 143);
const t2_colorPrimaryLight = Color(0XFFF2ECFD);
const t2_colorAccent = Color.fromARGB(255, 101, 45, 143);
