...
class SuccesReservDefaultPack extends StatefulWidget {
  final UserLoggedModel? userloggeddata;
  const SuccesReservDefaultPack(this.userloggeddata, {Key? key})
      : super(key: key);

  @override
  State<SuccesReservDefaultPack> createState() =>
      _SuccesReservDefaultPackViewState();
}

class _SuccesReservDefaultPackViewState extends State<SuccesReservDefaultPack> {
            ...
            child: Column(
              children: [
                GestureDetector(
                  child: RichText(
                    text: TextSpan(
                      text: 'Su Reservacion a sido Procesada con Exito!',
