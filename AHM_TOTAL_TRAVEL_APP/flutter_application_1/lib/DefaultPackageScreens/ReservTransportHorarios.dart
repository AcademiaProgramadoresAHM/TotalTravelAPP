...
import 'ReservTransportDetails.dart';

class ReservTransportHorario extends StatefulWidget {
  ...
  const ReservTransportHorario(
      ...
      this.transport);
  @override
  State<ReservTransportHorario> createState() => _ReservTransportHorarioState();
}

class _ReservTransportHorarioState extends State<ReservTransportHorario> {
  TimeOfDay time =
