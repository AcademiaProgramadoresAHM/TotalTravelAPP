...
class DefaultActivityExtraDetails extends StatefulWidget {
  ...
  const DefaultActivityExtraDetails(
    this.userloggeddata,
    this.Activity,
    this.Reservation,
    this.package,
...
class _ActivityDetails extends State<DefaultActivityExtraDetails> {
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Wrap(
                      ...
                      children: DefaultActivityExtraDetails(
