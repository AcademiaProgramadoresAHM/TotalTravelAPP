...
Future<void> PostEmailVerification(String email, BuildContext context) async {
  ...
  final url =
      Uri.parse("https://apitotaltravel.azurewebsites.net/API/Login/EmailVerification");
...
Future<void> PostEmailSender(
  ...
  final url = Uri.parse("https://apitotaltravel.azurewebsites.net/API/Login/EmailSender");
  final headers = {"Content-type": "application/json", "Accept": "text/plain"};
  final json = jsonEncode(loginData);
  final response = await post(url, headers: headers, body: json);
...
Future<void> changePassword(
  ...
  final url =
      Uri.parse("https://apitotaltravel.azurewebsites.net/API/Users/UpdatePassword");
  final headers = {"Content-type": "application/json", "Accept": "text/plain"};
  final json = jsonEncode(loginData);
...
Future<void> PostEmailContact(
  ...
  final url = Uri.parse(
      "https://apitotaltravel.azurewebsites.net/API/Login/EmailContact");
  final headers = {"Content-type": "application/json", "Accept": "text/plain"};
