...
class RoomDetailsEdits extends StatefulWidget {
  ...
  @override
  _RoomDetailsEdits createState() => _RoomDetailsEdits();
}

class _RoomDetailsEdits extends State<RoomDetailsEdits> {
  ...
  List<Padding> RoomDetailsEdits(List<dynamic> data, BuildContext context) {
    ...
    data.forEach((element) {
      ...
      widget.reservacionEditado!.habi_ID = element['id'];
      widget.reservacionEditado!.habi_Cantidad = rooms.round();
      widget.reservacionEditado!.habitacionreserv = element['habitacion'];
            ...
            FutureBuilder<dynamic>(
              builder: (context, snapshot) {
                return Wrap(
                    ...
                    children: RoomDetailsEdits(widget.Room, context));
              },
            ),
          ],
        )),
