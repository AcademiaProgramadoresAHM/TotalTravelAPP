...
import 'EditReservation_TransportDetails.dart';

class EditReservationHoraros extends StatefulWidget {
...
class _EditReservationHorarosState extends State<EditReservationHoraros> {
  TimeOfDay time =
  ...
  Future<dynamic> GetTransports(userloggeddata, idDetail) async {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => EditReservacionTransportDetails(
