...
import 'package:flutter_application_1/EditarReservScreen/EditReservation_RoomDetails.dart';
import 'package:http/http.dart' as http;
import 'package:nb_utils/nb_utils.dart';

import '../Components/Decodificador.dart';
import '../DefaultPackageScreens/ReservActExtDetails.dart';
import '../Models/DefaultPackageViewModel.dart';
import '../Models/ReservationViewModel.dart';
import '../Models/UsersViewModel.dart';
import 'EditReservation_start.dart';
import 'Editreservation_ActivityDetails.dart';

class EditReservationActivityExtras extends StatefulWidget {
...
class _EditReservationActivityExtrasState
    extends State<EditReservationActivityExtras> {
  Future<dynamic> GetListActivitiesExtras(
    ...
    if (bool == true) {
      if (response.statusCode == 200) {
        ...
        var activity =
            dataActivities.where((x) => x['ciudadID'] == IdCiudad).toList();
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => EditReservationActivityExtra(
            ...
            body: SingleChildScrollView(
              ...
              children: [
                FutureBuilder<dynamic>(
                  ...
                  future: GetListActivitiesExtras(
